...
public class RandomWithAnnotationProductAdderTest {
	private final static InputStream SYSTEM_IN = System.in;
	private static ProductAdder adder;

	@BeforeClass
	public static void setUp() {
		adder = new RandomWithAnnotationProductAdder(new ConsolePrinter());
	}
	...
	public void testAddProduct() {
		...
		sb.append("en").append(System.lineSeparator());
